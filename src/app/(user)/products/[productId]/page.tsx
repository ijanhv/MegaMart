      ...
      <div className="container grid grid-cols-1 sm:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <div className="flex items-center mb-4">
            ...
            <div className="text-sm text-secondary-600 ml-3">(134 Reviews)</div>
          </div>
          <div className="space-y-3">
            ...
            <p className="text-secondary-600 font-semibold space-x-2">
              <span>Brand: </span>{" "}
              <span className="text-secondary-500 ml-2">FableStreet</span>
            </p>
            <p className="text-secondary-600 font-semibold space-x-2">
              <span>Category: </span>{" "}
              <span className="text-secondary-500 ml-2">Clothing</span>
            </p>
            <p className="text-secondary-600 font-semibold space-x-2">
              <span>Size: </span>{" "}
          ...
          <div className="flex items-baseline mb-1 space-x-2 mt-3">
            <p className="text-2xl font-semibold text-primary-600">$45</p>
            <p className="text-lg text-secondary-500 line-through">$55</p>
          </div>

          <p className="text-secondary-500 mt-4">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Architecto
            non necessitatibus accusamus esse aliquam magni dignissimos ut
            reiciendis odit repellendus facere iusto, minima nostrum nobis. Quae
            molestias magnam est dicta!
          </p>
